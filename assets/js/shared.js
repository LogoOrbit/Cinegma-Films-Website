...
(function(){
  ...
  st.textContent=
    ...
    '.cg-modal{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) scale(.95);width:480px;max-width:92vw;background:#0e0e0e;border:1px solid rgba(124,92,255,.22);transition:transform .4s cubic-bezier(.2,.9,.3,1);box-shadow:0 30px 80px rgba(0,0,0,.6),0 0 40px rgba(124,92,255,.08);}'+
    ...
    '.cg-mtl{font-family:"Bebas Neue",sans-serif;font-size:1.2rem;letter-spacing:.22em;color:#7c5cff;}'+
    ...
    '.cg-sld{position:absolute;height:'+BH+'px;border-radius:2px;z-index:2;box-shadow:0 0 18px rgba(124,92,255,.3);}'+
    ...
    '.cg-prf{position:absolute;left:50%;z-index:10;font-family:"Bebas Neue",sans-serif;color:#7c5cff;pointer-events:none;opacity:0;animation:cgPUp .85s ease-out forwards;text-shadow:0 0 20px rgba(124,92,255,.5);}'+
    ...
    '.cg-glow{position:absolute;left:0;right:0;height:2px;background:linear-gradient(90deg,transparent,#7c5cff,transparent);z-index:5;pointer-events:none;opacity:0;animation:cgGlow .5s ease-out forwards;}'+
    ...
    '.cg-str-t{font-family:"Bebas Neue",sans-serif;font-size:3rem;letter-spacing:.12em;color:#7c5cff;margin-bottom:6px;text-shadow:0 0 30px rgba(124,92,255,.3);}'+
    ...
    '.cg-str-h{font-family:"DM Sans",sans-serif;font-size:.6rem;letter-spacing:.12em;color:rgba(124,92,255,.35);margin-top:24px;text-transform:uppercase;}'+
    ...
    '.cg-ov-t{font-family:"Bebas Neue",sans-serif;font-size:1.6rem;letter-spacing:.16em;color:#7c5cff;margin-bottom:4px;}'+
    ...
    '.cg-ov-hi{font-family:"DM Sans",sans-serif;font-size:.6rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(124,92,255,.5);margin-bottom:20px;}'+
    ...
    '.cg-ov-b{font-family:"Bebas Neue",sans-serif;font-size:.78rem;letter-spacing:.22em;background:0 0;border:1px solid rgba(124,92,255,.35);color:#7c5cff;padding:10px 28px;cursor:pointer;transition:all .3s;}'+
    '.cg-ov-b:hover{background:#7c5cff;color:#080808;}'+
    '.cg-toast{position:fixed;bottom:28px;left:28px;z-index:9000;background:rgba(14,14,14,.96);border:1px solid rgba(124,92,255,.22);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);padding:24px 28px 22px;max-width:280px;opacity:0;transform:translateY(16px);transition:opacity .5s,transform .5s;font-family:"DM Sans",sans-serif;pointer-events:none;}'+
    '.cg-toast.v{opacity:1;transform:translateY(0);pointer-events:all;}'+
    '.cg-tt{font-family:"Bebas Neue",sans-serif;font-size:1.05rem;letter-spacing:.18em;color:#7c5cff;display:block;margin-bottom:8px;}'+
    '.cg-td{font-size:.74rem;color:rgba(240,236,228,.5);line-height:1.6;margin:0 0 16px;font-weight:300;}'+
    '.cg-tb{font-family:"Bebas Neue",sans-serif;font-size:.74rem;letter-spacing:.2em;background:0 0;border:1px solid rgba(124,92,255,.35);color:#7c5cff;padding:8px 22px;cursor:pointer;transition:all .3s;}'+
    '.cg-tb:hover{background:#7c5cff;color:#080808;}'+
    ...
    '.cg-launch{display:inline-flex;align-items:center;gap:8px;background:0 0;border:1px solid rgba(124,92,255,.3);color:#7c5cff;font-family:"Bebas Neue",sans-serif;font-size:.74rem;letter-spacing:.2em;padding:10px 24px;margin:36px auto 0;cursor:pointer;transition:all .3s;}'+
    '.cg-launch:hover{background:#7c5cff;color:#080808;}'+
  ...
  function perfFx(){
    ...
    for(var i=0;i<cnt;i++){
      ...
      p.style.top='40%';
      p.style.background=Math.random()>0.4?'#7c5cff':'#f0ece4';
