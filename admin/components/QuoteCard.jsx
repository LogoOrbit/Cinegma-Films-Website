/*
 * QuoteCard — animated quote reveal.
 * No testimonials/quotes source exists in the dashboard data model, so the
 * quote and attribution are left as-is per the wiring rules.
 */
